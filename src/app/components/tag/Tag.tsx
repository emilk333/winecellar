...
export const Tag: FC<TagProps> = (tagProps) => {
    ...
    return(
        <div className={`h-full absolute left-initial lg:left-[-40px] top-[15px] after:content-[''] after:h-[calc(100%_-_40px)] after:w-[2px] after:absolute after:left-[5px] after:top-[10px] ${pseudoColor}`}>
